      ...
      <div className="flex items-center justify-between">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-10 pr-4 py-2.5 rounded-xl bg-foreground/[0.03] border border-foreground/[0.06] text-foreground text-sm placeholder:text-foreground/25 focus:outline-none focus:border-purple-500/30 w-64"
          />
        </div>
      </div>
